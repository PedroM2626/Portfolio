...
const ProjectsSection = () => {
  ...
  const initialProjects = [
    ...
    },
    {
      ...
      tech: [],
      category: "ai-ml",
      summary: t(`projects.dynamic.previsao-forecast.summary.${(i18n.language || "pt").split("-")[0]}`),
      description: t(`projects.dynamic.previsao-forecast.details.${(i18n.language || "pt").split("-")[0]}`),
      demoVideo: "",
      github: "https://github.com/PedroM2626/previsao-forecast",
      live: "",
    },
    {
      id: 100005,
